...
<html>
	<head>
		...
		<!-- <link rel="stylesheet" type="text/css" href="inner/css/normalize.css" /> -->
		<!-- <link rel="stylesheet" type="text/css" href="css/demo.css" /> -->
		<link rel="stylesheet" type="text/css" href="../inner/css/slideshow.css" />
		<link rel="stylesheet" type="text/css" href="../inner/css/slideshow_layouts.css" />
	...
	<body>
		<!-- Header -->
			<header id="header" class="preview">
				<div class="inner">
					<div class="content">
						<h1>Student Gymkahana, IIT Indore</h1>
		...
		<!-- Main -->
			<div id="preview">
				<div class="inner">
					<div class="content">
						<header>
							<h2>The Literary Club, IIT Indore</h2>
						</header>
						<p>ALL THE CONTENT BY LIT CLUB GOES HERE. bi nisi mauris, placerat sit amet feugiat nec, vehicula ut ex.</p>
					...
					<!-- contact -->
						<div class="contact" style>
							<header><h2>Club Head</h2></header>
							<img src="images/profile/1.jpg">
							<p>XYX</p>
							<button><a href="http://m.me/ayrusreev" target="_blank">Contact to club Head</a></button>
						</div>
			...
			<footer id="footer">
				...
				<div class="inner">
					...
					<div class="copyright">
						...
						&copy;Designed By : Mohit Mohta</a>
					</div>
				</div>
			</footer>
		...
		<!-- Scripts -->
			...
			<!-- slider begin -->
			<script src="../inner/js/imagesloaded.pkgd.min.js"></script>
		<script src="../inner/js/anime.min.js"></script>
