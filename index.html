						...
						<ul class="grid cs-style-1">
							<li>
								<figure>
									...
									<div class="front-small">
										<br><br>
										<h3>Why IIT-Indore?</h3>
									</div>
										<a href="pages/whyiiti.php">
											<figcaption>
												<h3 style="margin-top: 50px;">Why</h3>
												<span>IIT INDORE?<br>
							...
							<li>
								<figure>
									...
									<div class="front-big"><br>
										<h3>The Literary Club<br>IIT Indore</h3>
									</div>
										<a href="detail1.html">
											<figcaption>
							...
							<li>
								<figure>
									...
									<div class="front-small">
										...
										<a href="detail1.html">
											<figcaption>
												<h3 style="margin-top: 50px;">Publications</h3>
												<span>IIT INDORE<br>
													Club Head :James Bond<br>
												 	<span style="color : #7cc576;">Click for more details...</span>
											</figcaption>
